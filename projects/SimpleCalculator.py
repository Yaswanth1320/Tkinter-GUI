...
button_sqrt = Button(root, text="sqrt", padx=31, pady=20,command=button_sqrt)
...
button_rem = Button(root, text="%", padx=40, pady=20,command=button_rem)
...
button_rem.grid(row=5, column=0)
